...
# Load the model file
apm.apm_load(server,app,'softdrink2.apm')
...
# A usage < 30
CS = plt.contour(x1, x2,A_usage,[30.0, 28.0, 26.0],colors='r',linewidths=[4.0, 1.0, 0.5])
plt.clabel(CS, inline=1, fontsize=10)

# B usage < 44
CS = plt.contour(x1, x2,B_usage,[44.0, 42.0, 40.0],colors='b',linewidths=[4.0, 1.0, 0.5])
plt.clabel(CS, inline=1, fontsize=10)
